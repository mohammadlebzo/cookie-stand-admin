...
export default function LoginForm(props) {
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-center h-screen overflow-hidden bg-white rounded">
                <div className="w-10/12 bg-teal-600 lg:w-5/12 md:6/12 shadow-3xl border-2 border-green-500 rounded">
                    <form onSubmit={handleSubmit} className="p-12 md:p-24">
                        ...
                        <button className="w-full p-2 font-medium text-white uppercase bg-gradient-to-b from-gray-700 to-gray-900 md:p-4">SIGN IN</button>
                    </form>
                </div>
            </div>
        </>
